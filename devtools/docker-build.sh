...
if [[ "${TRAVIS_PULL_REQUEST}" == "false" ]]; then
    /io/conda-build-all --check-against omnia --check-against omnia/label/pre $UPLOAD /io/* || true
else
    /io/conda-build-all --check-against omnia --check-against omnia/label/pre $UPLOAD /io/*
fi
