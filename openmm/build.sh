...
if [[ "$OSTYPE" == "linux-gnu" ]]; then
    ...
    CMAKE_FLAGS+=" -DOSX_ARCHITECTURES:STRING=x86_64" # CUDA 6.5 no longer supports 32-bit
    export LINKER_FLAGS="-arch x86_64"
    CMAKE_FLAGS+=" -DSHARED_LINKER_FLAGS=$LINKER_FLAGS" # CUDA 6.5 no longer supports 32-bit
